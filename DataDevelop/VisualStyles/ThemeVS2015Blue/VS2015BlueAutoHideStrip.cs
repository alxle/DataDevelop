...
{
    internal class VS2015BlueAutoHideStrip : AutoHideStripBase
    {
        private class TabVS2015Blue : Tab
        {
            internal TabVS2015Blue(IDockContent content)
                : base(content)
            {
            }
        ...
        public VS2015BlueAutoHideStrip(DockPanel panel)
            : base(panel)
        {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (var brush = new SolidBrush(Color.FromArgb(0xFF, 41, 57, 85)))
            {
        ...
        private void DrawTabStrip(Graphics g, DockState dockState)
        {
            ...
            {
                foreach (TabVS2015Blue tab in pane.AutoHideTabs)
                    DrawTab(g, tab);
            }
        ...
        private GraphicsPath GetTabOutline(TabVS2015Blue tab, bool transformed, bool rtlTransform)
        {
        ...
        private void DrawTab(Graphics g, TabVS2015Blue tab)
        {
            ...
            g.FillRectangle(tab.IsMouseOver ? new SolidBrush(Color.FromArgb(255, 155, 167, 183)) : 
                new SolidBrush(Color.FromArgb(255, 70, 90, 125)), rectThickLine);
        ...
        private Rectangle GetTabRectangle(TabVS2015Blue tab)
        {
            return GetTabRectangle(tab, false);
        }

        private Rectangle GetTabRectangle(TabVS2015Blue tab, bool transformed)
        {
            DockState dockState = tab.Content.DockHandler.DockState;
            Rectangle rectTabStrip = GetLogicalTabStripRectangle(dockState);
        ...
        {
            GraphicsPath path = GetTabOutline((TabVS2015Blue)tab, true, true);
        ...
        private TabVS2015Blue lastSelectedTab = null;

        protected override void OnMouseHover(EventArgs e)
        {
            var tab = (TabVS2015Blue)TabHitTest(PointToClient(MousePosition));
            if (tab != null)
            {

...
{
    using WeifenLuo.WinFormsUI.ThemeVS2015Blue;

    internal class VS2015BlueDockPaneStrip : DockPaneStripBase
    {
        private class TabVS2015Blue : Tab
        {
            public TabVS2015Blue(IDockContent content)
                : base(content)
            {
            }
        ...
        {
            return new TabVS2015Blue(content);
        }
        ...
        private static Bitmap ImageButtonWindowList
        {
            get
            {
                if (m_imageButtonWindowList == null)
                    m_imageButtonWindowList = ThemeVS2015Blue.Resources.DockPane_Option;
        ...
        private static Bitmap ImageButtonWindowListOverflow
        {
            get
            {
                if (m_imageButtonWindowListOverflow == null)
                    m_imageButtonWindowListOverflow = ThemeVS2015Blue.Resources.DockPane_OptionOverflow;
        ...
        public VS2015BlueDockPaneStrip(DockPane pane)
            : base(pane)
        {
        ...
        private void CalculateTabs_ToolWindow()
        {
            ...
            foreach (TabVS2015Blue tab in Tabs)
            {
        ...
        private bool CalculateDocumentTab(Rectangle rectTabStrip, ref int x, int index)
        {
            ...
            var tab = Tabs[index] as TabVS2015Blue;
        ...
        private void CalculateTabs_Document()
        {
            ...
            {
                int tempX = x;
                var tab = Tabs[m_startDisplayingTab] as TabVS2015Blue;
        ...
        private void DrawTabStrip_Document(Graphics g)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                {
                    tabActive = Tabs[i] as TabVS2015Blue;
                    continue;
                }
                if (rectTab.IntersectsWith(rectTabOnly))
                    DrawTab(g, Tabs[i] as TabVS2015Blue, rectTab);
            }
        ...
        private void DrawTabStrip_ToolWindow(Graphics g)
        {
            ...
            for (int i = 0; i < Tabs.Count; i++)
                DrawTab(g, Tabs[i] as TabVS2015Blue, GetTabRectangle(i));
        }
        ...
        private Rectangle GetTabRectangle_ToolWindow(int index)
        {
            ...
            TabVS2015Blue tab = (TabVS2015Blue)(Tabs[index]);
        ...
        {
            Rectangle rectTabStrip = TabStripRectangle;
            var tab = (TabVS2015Blue)Tabs[index];
        ...
        private void DrawTab(Graphics g, TabVS2015Blue tab, Rectangle rect)
        {
            if (Appearance == DockPane.AppearanceStyle.ToolWindow)
        ...
        private void DrawTab_ToolWindow(Graphics g, TabVS2015Blue tab, Rectangle rect)
        {
            rect.Y += 1;
        ...
        private void DrawTab_Document(Graphics g, TabVS2015Blue tab, Rectangle rect)
        {
            if (tab.TabWidth == 0)
                return;

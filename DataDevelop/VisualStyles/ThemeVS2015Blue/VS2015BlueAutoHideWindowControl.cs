...
{
    internal class VS2015BlueAutoHideWindowControl : DockPanel.AutoHideWindowControl
    {
        private class VS2015BlueAutoHideWindowSplitterControl : SplitterBase
        {
            ...
            public VS2015BlueAutoHideWindowSplitterControl(DockPanel.AutoHideWindowControl autoHideWindow)
            {
        ...
        public VS2015BlueAutoHideWindowControl(DockPanel dockPanel) : base(dockPanel)
        {
            m_splitter = new VS2015BlueAutoHideWindowSplitterControl(this);

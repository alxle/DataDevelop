...
namespace WeifenLuo.WinFormsUI.Docking
{
    ...
    public class VS2015BlueTheme : ThemeBase
    {
		...
		public override void Apply(DockPanel dockPanel)
        {
            ...
            dockPanel.Extender.DockPaneCaptionFactory = new VS2015BlueDockPaneCaptionFactory();
            dockPanel.Extender.AutoHideStripFactory = new VS2015BlueAutoHideStripFactory();
            dockPanel.Extender.AutoHideWindowFactory = new VS2015BlueAutoHideWindowFactory();
            dockPanel.Extender.DockPaneStripFactory = new VS2015BlueDockPaneStripFactory();
            dockPanel.Extender.DockPaneSplitterControlFactory = new VS2015BlueDockPaneSplitterControlFactory();
            dockPanel.Extender.DockWindowSplitterControlFactory = new VS2015BlueDockWindowSplitterControlFactory();
            dockPanel.Extender.DockWindowFactory = new VS2015BlueDockWindowFactory();
            dockPanel.Extender.PaneIndicatorFactory = new VS2015BluePaneIndicatorFactory();
            dockPanel.Extender.PanelIndicatorFactory = new VS2015BluePanelIndicatorFactory();
            dockPanel.Extender.DockOutlineFactory = new VS2015BlueDockOutlineFactory();
        }

        private class VS2015BlueDockOutlineFactory : DockPanelExtender.IDockOutlineFactory
        {
            public DockOutlineBase CreateDockOutline()
            {
                return new VS2015BlueDockOutline();
            }

            private class VS2015BlueDockOutline : DockOutlineBase
            {
                public VS2015BlueDockOutline()
                {
        ...
        private class VS2015BluePanelIndicatorFactory : DockPanelExtender.IPanelIndicatorFactory
        {
            public DockPanel.IPanelIndicator CreatePanelIndicator(DockStyle style)
            {
                return new VS2015BluePanelIndicator(style);
            }

            private class VS2015BluePanelIndicator : PictureBox, DockPanel.IPanelIndicator
            {
                ...
                public VS2015BluePanelIndicator(DockStyle dockStyle)
                {
        ...
        private class VS2015BluePaneIndicatorFactory : DockPanelExtender.IPaneIndicatorFactory
        {
            public DockPanel.IPaneIndicator CreatePaneIndicator()
            {
                return new VS2015BluePaneIndicator();
            }

            private class VS2015BluePaneIndicator : PictureBox, DockPanel.IPaneIndicator
            {
                ...
                public VS2015BluePaneIndicator()
                {
                    SizeMode = PictureBoxSizeMode.AutoSize;
        ...
        private class VS2015BlueAutoHideWindowFactory : DockPanelExtender.IAutoHideWindowFactory
        {
            public DockPanel.AutoHideWindowControl CreateAutoHideWindow(DockPanel panel)
            {
                return new VS2015BlueAutoHideWindowControl(panel);
            }
        }

        private class VS2015BlueDockPaneSplitterControlFactory : DockPanelExtender.IDockPaneSplitterControlFactory
        {
        ...
        private class VS2015BlueDockWindowSplitterControlFactory : DockPanelExtender.IDockWindowSplitterControlFactory
        {
            public SplitterBase CreateSplitterControl()
            {
                return new VS2015BlueDockWindowSplitterControl();
            }
        }

        private class VS2015BlueDockPaneStripFactory : DockPanelExtender.IDockPaneStripFactory
        {
            public DockPaneStripBase CreateDockPaneStrip(DockPane pane)
            {
                return new VS2015BlueDockPaneStrip(pane);
            }
        }

        private class VS2015BlueAutoHideStripFactory : DockPanelExtender.IAutoHideStripFactory
        {
            public AutoHideStripBase CreateAutoHideStrip(DockPanel panel)
            {
                return new VS2015BlueAutoHideStrip(panel);
            }
        }

        private class VS2015BlueDockPaneCaptionFactory : DockPanelExtender.IDockPaneCaptionFactory
        {
        ...
        private class VS2015BlueDockWindowFactory : DockPanelExtender.IDockWindowFactory
        {
        ...
        public static DockPanelSkin CreateVisualStudio2013Blue()
        {
            ...
            skin.AutoHideStripSkin.DockStripGradient.StartColor = border;
            skin.AutoHideStripSkin.DockStripGradient.EndColor = border;
            skin.AutoHideStripSkin.TabGradient.TextColor = Color.White;
            skin.AutoHideStripSkin.TabGradient.StartColor = border;
            skin.AutoHideStripSkin.TabGradient.EndColor = border;
            ...
            skin.DockPaneStripSkin.ToolWindowGradient.DockStripGradient.StartColor = border;
            skin.DockPaneStripSkin.ToolWindowGradient.DockStripGradient.EndColor = border;
            ...
            skin.DockPaneStripSkin.ToolWindowGradient.InactiveTabGradient.EndColor = inactiveTab;
        ...
        internal class VS2015BlueDockWindowSplitterControl : SplitterBase
        {

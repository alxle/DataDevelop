...
{
	class VS2015ToolStripRenderer : ToolStripProfessionalRenderer
	{
		private static readonly VS2015ColorTable CustomColorTable = new VS2015ColorTable();

		public VS2015ToolStripRenderer()
		...
		/// <summary>
		///     Gets the color palette used for painting.VS2015ColorTable
		/// </summary>
		/// <value></value>
		/// <returns>The <see cref="CustomColorTable" /> used for painting.</returns>
		public new VS2015ColorTable ColorTable
		{
